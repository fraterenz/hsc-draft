...
${PATH2HSC}/target/release/hsc -c 100000 -y 82 -r 1 --r 1 --mu-exp 4 --mu-division 1.2 --mu-background 11.6 --p-asymmetric 0 --subsample 368 --snapshots 0 29 38 48 63 76 77 81 --seed ${SGE_TASK_ID} --sequential $PATH2SAVE
